...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThan30minParkingTime(){
        Date inTime = new Date();
        inTime.setTime( System.currentTimeMillis() - (  24 * 60 * 1000) );//24 min parking time should give free parking fare 
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
    ...
    public void calculateFareRecurrentCarWithMoreThanADayParkingTime(){
      ...
      //  assertEquals( ((24 * Fare.CAR_RATE_PER_HOUR) * (1 - 0.05)) , ticket.getPrice());
    }
    ...
    public void calculateFareRecurrentBikeWithLessThanOneHourParkingTime(){
        ...
        System.out.println("prix attendu : " + Math.round(0.95*0.75*Fare.BIKE_RATE_PER_HOUR*100.0)/100.0);
    ...
    public void calculateFareRecurrentCar(){
        ...
        fareCalculatorService.calculateFare(ticket,true);
        System.out.println("prix : "+ ticket.getPrice());
        System.out.println("prix attendu : " + Math.round(0.95*Fare.CAR_RATE_PER_HOUR*100.0)/100.0 );
